import { Circle, Header, LeftSide, Logo, Nav, NavItem, NavLinks, NavOptions, StyledChevronRightIcon, StyledMenuIcon, StyledMenuOpenIcon } from './NavBar.style'
  ...
  return (
    <Header $menu={menu}>
      <Nav $menu={menu}>
        ...
        <NavLinks $menu={menu}>
          {windowWidth < 768 ? planets.map((item, index) => (
